...
{
    // DTO hiển thị danh sách đơn hàng (Bảng bên ngoài)
    public class OrderAdminListDto
    {
        public int OrderId { get; set; }
        public string CustomerName { get; set; } // Lấy từ RecipientName
    ...
    public class OrderDetailDto
    {
        ...
        public string ProductImage { get; set; } // Nếu có ảnh
    ...
    // DTO để nhận request cập nhật trạng thái
